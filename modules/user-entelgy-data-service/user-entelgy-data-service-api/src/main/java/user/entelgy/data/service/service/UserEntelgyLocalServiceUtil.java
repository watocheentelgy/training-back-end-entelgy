...
/**
 * Provides the local service utility for UserEntelgy. This utility wraps
 * <code>user.entelgy.data.service.service.impl.UserEntelgyLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserEntelgyLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>user.entelgy.data.service.service.impl.UserEntelgyLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static UserEntelgy addUserEntelgy(UserEntelgy userEntelgy) {
		return getService().addUserEntelgy(userEntelgy);
	}
	 ...
	 */
	public static UserEntelgy createUserEntelgy(long userEntelgyId) {
		return getService().createUserEntelgy(userEntelgyId);
	}
	 ...
	 */
	public static UserEntelgy deleteUserEntelgy(long userEntelgyId)
		throws PortalException {

		return getService().deleteUserEntelgy(userEntelgyId);
	}
	 ...
	 * @return the user entelgy that was removed
	 */
	public static UserEntelgy deleteUserEntelgy(UserEntelgy userEntelgy) {
		return getService().deleteUserEntelgy(userEntelgy);
	}
	...
	public static UserEntelgy fetchUserEntelgy(long userEntelgyId) {
		return getService().fetchUserEntelgy(userEntelgyId);
	}
	 ...
	 */
	public static List<UserEntelgy> getUserEntelgies(int start, int end) {
		return getService().getUserEntelgies(start, end);
	}
	 ...
	 */
	public static int getUserEntelgiesCount() {
		return getService().getUserEntelgiesCount();
	}
	 ...
	 * @throws PortalException if a user entelgy with the primary key could not be found
	 */
	public static UserEntelgy getUserEntelgy(long userEntelgyId)
		throws PortalException {

		return getService().getUserEntelgy(userEntelgyId);
	}
	 ...
	 */
	public static UserEntelgy updateUserEntelgy(UserEntelgy userEntelgy) {
		return getService().updateUserEntelgy(userEntelgy);
	}

	public static UserEntelgyLocalService getService() {
		return _service;
	}

	private static volatile UserEntelgyLocalService _service;
