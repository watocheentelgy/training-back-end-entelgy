...
/**
 * Provides the local service interface for UserEntelgy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserEntelgyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserEntelgyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>user.entelgy.data.service.service.impl.UserEntelgyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user entelgy local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserEntelgyLocalServiceUtil} if injection and service tracking are not available.
	 */
