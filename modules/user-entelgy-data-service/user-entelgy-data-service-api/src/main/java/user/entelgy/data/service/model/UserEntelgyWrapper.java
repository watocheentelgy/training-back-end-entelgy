...
/**
 * <p>
 * This class is a wrapper for {@link UserEntelgy}.
 * </p>
 *
 ...
 * @generated
 */
public class UserEntelgyWrapper
	extends BaseModelWrapper<UserEntelgy>
	implements ModelWrapper<UserEntelgy>, UserEntelgy {

	public UserEntelgyWrapper(UserEntelgy userEntelgy) {
		super(userEntelgy);
	}
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("userEntelgyId", getUserEntelgyId());
		...
		attributes.put("activeUser", getActiveUser());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Long userEntelgyId = (Long)attributes.get("userEntelgyId");

		if (userEntelgyId != null) {
			setUserEntelgyId(userEntelgyId);
		}
		...
		Boolean activeUser = (Boolean)attributes.get("activeUser");
	...
	public void setUserEntelgyId(long userEntelgyId) {
		model.setUserEntelgyId(userEntelgyId);
	}
	...
	@Override
	protected UserEntelgyWrapper wrap(UserEntelgy userEntelgy) {
		return new UserEntelgyWrapper(userEntelgy);
	}
